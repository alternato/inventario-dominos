...
import { ESTADOS, ESTADO_STYLE, getTipoIcon, getTipoColor } from '../components/activos/constants';
import { EstadoBadge } from '../components/activos/EstadoBadge';
...
export const ActivosPage = () => {
  ...
  return (
    ...
    <div className="flex gap-0" style={{ minHeight: 0 }}>
      ...
      {/* ── Columna principal ───────────────────────────────────── */}
      <div
        className="flex-1 flex flex-col gap-5 transition-all duration-300 2xl:px-4"
        style={{ minWidth: 0 }}
      >
        {/* Header */}
